...
\textbf{Switch-Netzwerk}
\begin{center}
    \begin{tabular}{@{} l l r@{}}\toprule    
    {Switch} & {IP-Adresse} & {Subnetzmaske}\\ \midrule
    HP1 & 10.10.1.11 & 255.255.255.0\\ \addlinespace
    HP2 & 10.10.1.11 & 255.255.255.0\\ \addlinespace
    HP3 & 10.10.1.11 & 255.255.255.0\\ \addlinespace
    HP4 & 10.10.1.12 & 255.255.255.0\\ 
    \bottomrule
    \end{tabular}
\end{center}
\subsubsection{VLAN}
