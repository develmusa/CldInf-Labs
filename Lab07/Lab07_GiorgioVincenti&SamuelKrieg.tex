...
\begin{figure} [H]
	...
	\end{center}
\end{figure}
Bei diesem Versuch hingegen wird direkt gepingt mit einer Encapsulation durch unser VXLAN gefahren. Dies erkennt man, weil unser Packet nur einmal eingepackt wurde und mit der VNI 8000 markiert wurde. Hier wird von HP4 (Ubuntu Srv 1) zu HP1 (Ubuntu Srv 2) gepingt.  
